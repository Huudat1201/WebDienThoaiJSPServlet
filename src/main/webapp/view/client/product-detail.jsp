...
<!--  content -->
  ...
  <section id="aa-catg-head-banner">
      <img src="${pageContext.request.contextPath}/view/client/assets/images/list.jpg" alt="banner sản phẩm" style="height: 305px;width: 1686px">
                ...
                <div class="tab-pane fade " id="review">
                 <div class="aa-product-review-area">
                   ...
                   <form action="${pageContext.request.contextPath}/view/client/review?id=${detail_product.id}" method="post" class="aa-review-form">
                      ...
                      <button type="submit" class="btn btn-default aa-review-submit" style = "background: #261c78;">Gửi</button>
                   </form>
                 </div>
                </div>            
              </div>
