        ...
        <ul class="navbar-nav align-items-center right-nav-link">
          <li class="nav-item">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javaScript:void();">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h6 class="mt-2 user-title">Webdienthoai</h6>
			 ...
			 <li class="dropdown-item" style = "text-align: center;"><a href="${pageContext.request.contextPath}/admin/logout" style = "color: red;"> Đăng xuất</a></li>		
            </ul>
          </li>
        </ul>
      </nav>
